...
function printHelp() {
  process.stdout.write(
    [
      ...
      'Usage:',
      '  oss-scorecard help',
      '  oss-scorecard audit <owner/repo[@ref]> [--format terminal|json|markdown] [--json-out <path>] [--markdown-out <path>]',
      '  oss-scorecard index [--root .] [--strict=false]',
      '  oss-scorecard score <owner/repo[@ref]> [--json-out <path>]',
      '  oss-scorecard score --legacy [--config tools/scorecard-run.config.json] [--strict=false]',
      '  oss-scorecard history [--format=json]',
      '',
      'Commands:',
      '  audit    Run the bootstrap repo audit CLI against a real GitHub repository or branch ref or branch ref',
...
function printScoreHelp() {
  process.stdout.write(
    [
      ...
      '',
      'Modes:',
      '  default   Score a live GitHub repository (or ref) and emit ScoreReport JSON with evidence trail',
